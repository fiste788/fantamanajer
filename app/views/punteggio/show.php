<?php if($this->titolari != NULL): ?>
    <?php if($this->punteggio->punteggio > $this->media + 5): ?>
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach($this->titolari as $key => $giocatore): ?>
                    <tr<?php echo ($giocatore->considerato == 0) ? ' class="alert-danger"' : '' ?>>
                        ...
                        <td class="hidden-phone"><?php if($giocatore->ammonito): ?><i class="glyphicon glyphicon-ok"></i><?php endif; ?></td>
                        <td class="hidden-phone"><?php if($giocatore->espulso): ?><i class="glyphicon glyphicon-ok"></i><?php endif; ?></td>
