...
<html>
	<body style="font-family:'Trebuchet MS',Arial,sans-serif;overflow:hidden">
		<a title="Home" href="<?php echo Router::getInstance()->generate('home'); ?>">
			<img style="border:0 none" alt="Header-logo" src="<?php echo IMGSURL . 'header.png'; ?>" />
		</a>
		<div>
			<h3>
				<a style="color:#00a2ff;text-decoration:none;" href="<?php echo Router::getInstance()->generate('dettaglio_giornata',array('giornata'=>$this->giornata,'squadra'=>$this->utente->id)); ?>">Punteggio: <?php echo $this->somma; ?></a>
			</h3>
				...
				<table width="100%">
	            	...
	            	<?php foreach($tito as $key => $val): ?>
						...
						<?php if($val->considerato == 0): ?>
							<td>
								<a href="<?php echo Router::getInstance()->generate('dettaglioGiocatore',array('id'=>$val->id)); ?>">
			...
			<div>
				<h3>
					<a style="color:#00a2ff;text-decoration:none;" href="<?php echo Router::getInstance()->generate('classifica'); ?>">Classifica</a>
				</h3>
				<table width="300">
					<tbody>
						<tr>
