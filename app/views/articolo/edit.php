<form class="form-horizontal" method="post" action="<?php echo $this->router->generate('articolo_update',array('id'=>$this->articolo->id)); ?>">
	<fieldset>
	...
	<fieldset>
        ...
        <a class="btn btn-danger" href="<?php echo $this->router->generate('articolo_delete',array('id'=>$this->articolo->id)) ?>">Cancella</a>
