...
<div class="row-fluid">
    <?php if ($this->eventi != FALSE): ?>
        <div id="eventi" class="span6 well">
            ...
            <div>
                ...
                <div class="all">
                    <a href="<?php echo $this->router->generate('feed'); ?>">Vedi tutti gli eventi <i class="icon-chevron-right"></i></a>
                </div>
            </div>
        </div>
    <?php endif; ?>
    <?php if ($this->articoli != FALSE) : ?>
        <div id="conferenzeStampa" class="span6 well">
                        ...
                        <em>
                            ...
                            <span class="right">
                                ...
                                <?php if ($_SESSION['logged'] && $_SESSION['idUtente'] == $articolo->idUtente): ?>
                                    <a class="icon-edit" href="<?php echo $this->router->generate('articolo_edit', array('id' => $articolo->id)); ?>" title="Modifica">&nbsp;</a>
                                <?php endif; ?>
                            </span>
                        </em>
            ...
            <?php endforeach; ?>
            <div class="all">
                <a href="<?php echo $this->router->generate('articoli') ?>">Vedi tutte le conferenze stampa <i class="icon-chevron-right"></i></a>
            </div>
        </div>
    <?php endif; ?>
</div>