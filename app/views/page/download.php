<form class="form-horizontal" action="<?php echo $this->router->generate('download'); ?>" method="post">
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select class="form-control" disabled="disabled" id="giornataSelect" name="giornata">
                    <option></option>
