...
<?php endif; ?>
<?php if($_SESSION['logged'] && $_SESSION['idUtente'] == $this->filterId && count($this->trasferimenti) < $_SESSION['datiLega']->numTrasferimenti && $this->currentGiornata > 1 && !empty($this->giocatoriSquadra)): ?>
	...
	<form action="<?php echo $this->router->generate('selezione_update',array('squadra'=>$_SESSION['idUtente'])); ?>" method="post">
		<fieldset>
