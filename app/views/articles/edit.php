<div class="mdl-container">
    <section class="mdl-grid mdl-grid--no-spacing mdl-shadow--4dp">
        <form class="form-horizontal" method="post" action="<?php echo $this->router->generate('articles_update', array('id' => $this->article->id)); ?>">
            <fieldset>
                ...
                <a class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" href="<?php echo $this->router->generate('articles_delete', array('id' => $this->article->id)) ?>">Cancella</a>
