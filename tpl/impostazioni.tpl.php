<form class="form-horizontal" action="<?php echo Links::getLink('impostazioni'); ?>" method="post">
	<fieldset>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="hidden" name="capitano" value="0"/>
				<label class="checkbox">
					<input type="checkbox" name="capitano" value="1"<?php echo ($this->lega->capitano) ? ' checked="checked"' : ''; ?> />Si
				</label>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<label class="checkbox">
					<input type="checkbox" name="jolly" value="1"<?php echo ($this->lega->jolly) ? ' checked="checked"' : ''; ?> />Si
				</label>
