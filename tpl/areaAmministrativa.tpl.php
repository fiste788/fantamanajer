...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'squadre.png'; ?>" title="Gestione Squadre" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'transfert.png'; ?>" title="Gestione trasferimenti" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'formazione.png'; ?>" title="Gestione formazioni" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'contatti.png'; ?>" title="Newsletter" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'penalita.png'; ?>" title="Gestione penalità" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'impostazioni.png'; ?>" title="Modifica impostazioni" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'freeplayer.png'; ?>" title="Modifica giocatore" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'run.png'; ?>" title="Lancia script" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'gestione-database.png'; ?>" title="Gestione database" />
...
<div class="box column last">
	<img height="64" width="64" class="column" alt="->" src="<?php echo IMGSURL . 'calendario.png'; ?>" title="Gestione giornate" />
