...
<div id="operazioni" class="column last">
	...
	<?php endif; ?>
		...
		<li><a class="see-transfert column last operazione" href="<?php echo Links::getLink('trasferimenti',array('squadra'=>$squadra)); ?>">Guadra i trasferimenti</a></li>
		<li><a class="see-freeplayer column last operazione" href="<?php echo Links::getLink('giocatoriLiberi'); ?>">Guadra i giocatori liberi</a></li>
		<li><a class="see-premi column last operazione" href="<?php echo Links::getLink('premi'); ?>">Guadra i premi</a></li>
