<?php foreach($this->elencoSquadre as $key => $val): ?>
	...
	<?php if(file_exists(UPLOADDIR . $val->id . '-med.jpg')): ?>
		<a rel="group" title="<?php echo $val->nome; ?>" class="fancybox" href="<?php echo UPLOADURL . $val->id . '-original.jpg'; ?>" >
	...
	<?php else: ?>
		<img height="93" width="124" class="logo" alt="<?php echo $val->id; ?>" src="<?php echo IMGSURL . 'no-foto.png'; ?>" title="<?php echo $val->nomeSquadra; ?>" />
	<?php endif; ?>
