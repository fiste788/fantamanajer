...
$pages->addPage('squadra_show','Dettaglio squadra',-1,'squadre',FALSE,array('tablesorter'=>'tablesorter','fancybox'=>'fancybox','fileupload'=>array('jquery.iframe-transport','vendor/jquery.ui.widget','jquery.fileupload','jquery.fileupload-ui')));
