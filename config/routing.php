...
$router->map('GET', '/contatti', '', 'contatti');
$router->map('GET', '/articoli', 'articolo#index', 'articoli');
...
$router->map('GET', '/giocatori/[i:id]', 'giocatore#show', 'giocatore_show');
...
$router->map('GET', '/trasferimenti', 'trasferimento#index', 'trasferimento_index');
$router->map('GET', '/trasferimenti/[i:id]', 'trasferimento#show', 'trasferimento_show');
