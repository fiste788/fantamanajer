...
$router->map('GET', '/lineups', array('controller'=>'lineups','action'=>'show'), 'lineups');
$router->map('GET', '/lineups/[i:giornata]?/[i:squadra]?', array('controller'=>'lineups','action'=>'show'), 'lineups_show');
//$router->map('GET', '/formazione', array('controller'=>'formazione','action'=>'build'), 'formazione_edit');
$router->map('POST', '/lineups', array('controller'=>'lineups','action'=>'update'), 'lineups_update');
//$router->map('GET', '/formazione/new', 'formazione','action'=>'build', 'formazione_new');
$router->map('GET', '/lineups/insert_old', array('controller'=>'lineups','action'=>'insertOld'), 'lineups_insert');
...
$router->map('POST', '/selection/[i:team_id]?', array('controller'=>'selection','action'=>'update'), 'selection_update');
