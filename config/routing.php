...
$router->setBasePath('/fantamanajer-dispatcher');
...
$router->map('GET', '/giocatori/liberi', array('controller'=>'giocatore','action'=>'free'), 'giocatori_liberi');
...
$router->map('GET', '/trasferimenti/[i:idUtente]?', array('controller'=>'trasferimento','action'=>'index'), 'trasferimento_index');
...
$router->map('GET', '/dettaglio_giornata/[i:idGiornata]/[i:idUtente]', array('controller'=>'punteggio','action'=>'show'), 'punteggio_show');
